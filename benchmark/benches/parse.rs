...
pub fn from_str(c: &mut Criterion) {
    ...
    macro_impl!(group, 256, "-3.4028236692093846346337460743176821145554343232345");
    macro_impl!(group, 256, "-9.157920892373161954235709850086879078532699846656405640394573129639935");
    macro_impl!(group, 256, "-1.15792089237316195423570985008687907853269984665640564039457584007913129639935");
