macro_rules! from_float {
    (FROM $f: ident, $dec: ident, $D: ident) => {
        #[rstest(::trace)]
        #[case(0., $dec!(0))]
        #[case(0.0, $dec!(0))]
        #[case(0.0000, $dec!(0))]
        ...
        #[case(0.156250000000000000000000000000000000000000, $dec!(0.15625))]
        #[case(0.25, $dec!(0.25))]
        ...
        fn test_from(#[case] n: $f, #[case] expected: $D) {
    ...
    (FROM NEG INF $f: ident, $dec: ident, $D: ident) => {
        #[rstest(::trace)]
        fn test_from_neg_inf() {
    ...
    (FROM U $f: ident, $dec: ident, $D: ident) => {
        ...
        fn test_from_unsigned_neg(#[case] n: $f) {
    ...
    (FROM S $f: ident, $bits: literal, $dec: ident, $D: ident) => {
        ...
        fn test_from_signed(#[case] n: $f, #[case] expected: $D) {
            let d = $D::try_from(n).unwrap();
            assert_eq!(d, expected);
            assert_eq!(d.op_signals(), signals![]);
        }
