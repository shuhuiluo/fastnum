...
impl<'expr, const N: usize> AsExpression<Numeric> for &'expr UnsignedDecimal<N> {
...
impl<'expr, const N: usize> AsExpression<Nullable<Numeric>> for &'expr UnsignedDecimal<N> {
