...
| Decimal digits |   `f64`   | `fastnum` | `bigdecimal` |
|:--------------:|:---------:|:---------:|:------------:|
|       2        | 582.68 ps | 30.360 ns |  89.885 ns   |
|       24       | 536.08 ps | 14.969 ns |  49.829 ns   |
|       39       | 574.84 ps | 31.056 ns |  92.175 ns   |
|       40       | 562.10 ps | 28.608 ns |  141.49 ns   |
...
| Decimal digits |   `f64`   | `fastnum` | `bigdecimal` |
|:--------------:|:---------:|:---------:|:------------:|
|       1        | 582.18 ps | 27.334 ns |  139.57 ns   |
|       24       | 582.95 ps | 16.212 ns |  53.673 ns   |
|       39       | 673.32 ps | 30.531 ns |  67.340 ns   |
...
|       88       | 617.74 ps | 67.947 ns |  447.37 ns   |
...
| Decimal digits |   `f64`   | `fastnum` | `bigdecimal` |
|:--------------:|:---------:|:---------:|:------------:|
|       1        | 586.88 ps | 10.646 ns |  95.847 ns   |
|       13       | 579.58 ps | 80.984 ns |  167.81 ns   |
|       77       | 587.59 ps | 865.31 ns |  9.1258 µs   |
|      154       | 559.58 ps | 4.9901 µs |  9.1213 µs   |
...
We have more than `9000` tests, so we recommend running it using [`nextest`](https://nexte.st/):
